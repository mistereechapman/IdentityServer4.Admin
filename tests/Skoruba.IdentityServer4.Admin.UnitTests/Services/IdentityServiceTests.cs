...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Services
{
    public class IdentityServiceTests
    {
        ...
        private IIdentityRepository<Guid, Guid, UserIdentity, UserIdentityRole, Guid,
            ...
            IMapper mapper)
        {
            return new IdentityRepository<AdminIdentityDbContext, Guid, Guid, UserIdentity, UserIdentityRole, Guid,
                UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim,
                UserIdentityUserToken>(dbContext, userManager, roleManager, mapper);
        }

        private IIdentityService<UserDto<Guid>, Guid, RoleDto<Guid>, Guid, Guid, Guid, UserIdentity,
            ...
            RoleClaimsDto<Guid>> GetIdentityService(IIdentityRepository<Guid, Guid, UserIdentity, UserIdentityRole, Guid, UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken> identityRepository,
            IIdentityServiceResources identityServiceResources,
            IMapper mapper)
        {
            return new IdentityService<UserDto<Guid>, Guid, RoleDto<Guid>, Guid, Guid, Guid, UserIdentity,
                UserIdentityRole, Guid,
                UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim,
                UserIdentityUserToken,
                UsersDto<UserDto<Guid>, Guid>, RolesDto<RoleDto<Guid>, Guid>, UserRolesDto<RoleDto<Guid>, Guid, Guid>,
                UserClaimsDto<Guid>, UserProviderDto<Guid>, UserProvidersDto<Guid>, UserChangePasswordDto<Guid>,
                RoleClaimsDto<Guid>>(identityRepository, identityServiceResources, mapper);
        }
        ...
        private IMapper GetMapper()
        {
            return new MapperConfiguration(cfg => cfg.AddProfile<IdentityMapperProfile<UserDto<Guid>, Guid, RoleDto<Guid>, Guid, UserIdentity, UserIdentityRole, Guid,
                        ...
                        UserIdentityUserToken,
                        UsersDto<UserDto<Guid>, Guid>, RolesDto<RoleDto<Guid>, Guid>, UserRolesDto<RoleDto<Guid>, Guid, Guid>,
                        UserClaimsDto<Guid>, UserProviderDto<Guid>, UserProvidersDto<Guid>,
        ...
        {
            var testUserManager = IdentityMock.TestUserManager(new UserStore<UserIdentity, UserIdentityRole, AdminIdentityDbContext, Guid, UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityUserToken, UserIdentityRoleClaim>(context, new IdentityErrorDescriber()));
        ...
        {
            var testRoleManager = IdentityMock.TestRoleManager(new RoleStore<UserIdentityRole, AdminIdentityDbContext, Guid, UserIdentityUserRole, UserIdentityRoleClaim>(context, new IdentityErrorDescriber()));
        ...
        public async Task AddUserAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                var userDto = IdentityDtoMock<Guid>.GenerateRandomUser();
        ...
        public async Task AddUserRoleAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                var roleDto = IdentityDtoMock<Guid>.GenerateRandomRole();
